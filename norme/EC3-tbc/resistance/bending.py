...
class Bending:
    ...
    def __init__(self, My_ed: float = 0.0, Mz_ed: float = 0.0,
        ...
        **kwargs
        ...
        self.__section_type = (sec.section_type if sec
...
def mc_rd(W: float, fy: float, gamma_m0: float = 1.0) -> float:
    """
    Calcul rapide du moment résistant Mc,Rd.

    Parameters
    ----------
    W : float
        Module de résistance [mm³] (Wpl ou Wel selon la classe).
    fy : float
